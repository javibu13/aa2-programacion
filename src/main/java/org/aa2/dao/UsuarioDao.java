...
public interface UsuarioDao {
    ...
    @SqlUpdate("UPDATE Usuario SET Nombre = :nombre, Correo = :correo, Password = :password, AvatarPath = :avatarPath, Rol = :rol WHERE Id = :id")
    void updateUsuario(@Bind("id") int id, @Bind("nombre") String nombre, @Bind("correo") String correo, @Bind("password") String password, @Bind("avatarPath") String avatarPath, @Bind("rol") String rol);
